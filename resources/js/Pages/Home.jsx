            ...
            <section>
                {flash?.message && (
                    <div
                        ...
                        } shadow-lg bottom-4 flex items-center gap-2 w-fit right-4 absolute text-xs text-white p-3 rounded-md z-100 mb-4 transition-all duration-500 transform ${
                            showMessage
                        ...
                        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                            <div className="flex flex-col justify-center text-center md:text-left z-10">
                                ...
                                <p className="mt-4 text-base sm:text-sm md:text-sm font-medium  dark:text-gray-400 text-gray-700 text-balance">
                                    Join our community of builders and
                                    contribute to sustainable construction
                                    practices through material trading and
                                    donations.
                                </p>
                                <div className="mt-6 sm:mt-8 flex flex-wrap gap-4">
                                    <Link
                                        href="#second"
                                        className="rounded-full p-3 grow text-center bg-green-500 text-white font-bold uppercase text-sm tracking-widest hover:bg-green-600 transition"
                                    >
                                        Get Started
                                    </Link>
                                    <Link
                                        href="about"
                                        className="rounded-full p-3 grow border text-center border-green-500 text-green-500 font-bold uppercase text-sm tracking-widest hover:bg-green-500 hover:text-black transition"
                                    >
                                        Learn More
                                    </Link>
                                </div>
            ...
            <section id="second" className="bg-white py-12">
                <div className="max-w-6xl mx-auto px-4">
                    ...
                    <h2 className="text-3xl font-bold text-gray-800 text-center mb-10">
                        <Link href="/materials">Featured Materials</Link>
                    </h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                        {[
                            ...
                            >
                                ...
                                <h3
                                    className={`font-bold text-xl mb-2 ${item.textColor}`}
                                >
                                    {item.title}
                                </h3>
                                <p
                                    className={`text-sm ${item.textColor === "text-white" ? "text-gray-200" : "text-gray-800"}`}
                                >
                                    {item.desc}
                                </p>
                            </div>
                ...
                <section className="bg-green-600 text-white py-16 text-center">
                    <div className="max-w-4xl mx-auto px-4">
                        ...
                        <button
                            ...
                            className="mt-6 cursor-pointer bg-white text-green-600 font-semibold px-6 py-2 rounded-full shadow-md hover:bg-gray-100 transition"
                        >
                            Sign Up
                        </button>
                    </div>
