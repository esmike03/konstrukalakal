...
import { ArrowLeft, ArrowRight, MessageCircle, CheckCircle, X, Eye } from "lucide-react";
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {filteredTrades.map((trade) => (
                                ...
                                >
                                    ...
                                    <div className="mb-3">
                                        <p
                                            className={`text-xs font-bold uppercase tracking-wide text-center rounded-full px-3 py-1 w-fit mx-auto text-white ${trade.status === "pending"
                                                ? "bg-amber-400"
